            ...
            <div class="sidebar-wrapper active">
                <div class="sidebar-header position-relative">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="logo">
                            <a href="<?= base_url('dashboard') ?>"><img src="<?= base_url() ?>/assets\cms\Logo\dapenbukopin_lg.png" alt="Logo" srcset=""></a>
                        </div>
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        ?>
                            <li
                                class="sidebar-item <?php if ($url == "SaldoUsers") {
                                                        echo "active";
                                                    } ?>">
                                <a href="<?= base_url() ?>SaldoUsers" class='sidebar-link'>
                                    <i class="bi bi-grid-fill"></i>
