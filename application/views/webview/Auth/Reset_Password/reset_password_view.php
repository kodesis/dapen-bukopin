        ...
        <div class="row h-100">
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    ...
                    <form id="login_form">
                        <input type="hidden" name="token_reset" value="<?= $this->uri->segment(3) ?>">
                    ...
                    <button onclick="confirm_reset()" class="btn btn-primary btn-block btn-lg shadow-lg mt-5">Reset</button>
                    <div class="text-center mt-5 text-lg fs-4">
                        ...
                        <p class="text-gray-600">Don't have an account? <a href="<?= base_url('auth/register') ?>" class="font-bold">Sign
                                up</a>.</p>
                        <!-- <p><a class="font-bold" href="<?= base_url('auth/forgetpassword') ?>">Forgot password?</a>.</p> -->
                    </div>
                </div>
            </div>
