                    ...
                    <div class="card-body">
                        <form id="cari_bulan_form">
                            ...
                            <div class="row">
                                ...
                                ?>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="basicInput">Pilih User Relasi</label>
                                            <fieldset class="form-group">
                                                <select class="form-select" id="id_relasi" name="id_relasi">
                                                    <!-- <option selected disabled>-- Pilih User --</option> -->
                                                    <option selected value="<?= $this->session->userdata('user_user_id') ?>"><?= $this->session->userdata('kd_peserta') . ' - ' . $this->session->userdata('name') ?></option>

                                                    <?php
                                                    foreach ($relasi as $r) {
                                                    ?>
                                                        <option value="<?= $r->uid ?>"><?= $r->kd_peserta . ' - ' . $r->nama ?></option>
                                                    <?php
                                                    }
                                                    ?>
                                                </select>
                                ...
                                ?>
                                    <input type="hidden" id="id_relasi" name="id_relasi" value="<?= $this->session->userdata('user_user_id') ?>">
                                <?php
                                }
                                ?>
                                <div class="col-md-6">
        ...
        <section class="section fade" id="tab_ketemu">
            <div class="card">
                <div class="card-header">
                    <h2 class="card-title" id='nama_user'></h2>
