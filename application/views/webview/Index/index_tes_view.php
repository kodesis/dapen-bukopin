...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url() ?>/assets/user/css/odometer.css">
...
<body>
    ...
    <div id="preloader">
        <div id="loader" class="loader">
            <div class="loader-container">
                <div class="loader-icon"><img src="<?= base_url() ?>/assets/user/img/logo/preloader.png" alt="Preloader"></div>
            </div>
        </div>
    </div>
    <!--Preloader-end -->
                                    ...
                                    <ul class="navigation">
                                        <li class="active menu-item-has-children"><a href="#">Home</a>
                                            <ul class="sub-menu">
                                                ...
                                                <li class="active"><a href="index-7.html">07. Accounting Services</a></li>
    ...
    <main class="fix">
                        ...
                        <div class="col-lg-6">
                            <div class="banner-col-1">
                                <div class="section-title mb-20 tg-heading-subheading animation-style3">
                                    ...
                                    <h2 class="title tg-element-title text-60-bold">Accounting platform<span>using</span> AI <span>technology</span> </h2>
                                </div>
                                <p class="mb-5">Empower decision-making with real-time financial reporting</p>
                                ...
                                <div class="box-authors mt-65">
                                    <div class="box-img-author">
                                        <img src="<?= base_url() ?>/assets/user/img/home7/author.png" />
                                        <img src="<?= base_url() ?>/assets/user/img/home7/author2.png" />
                                        <img src="<?= base_url() ?>/assets/user/img/home7/author3.png" />
                                        <img src="<?= base_url() ?>/assets/user/img/home7/author4.png" />
                                        <span class="item-author-more">+28k</span>
                                    </div>
                    ...
                    <div class="swiper-container slider_baner__active slider_baner_home6">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide slide__home7">
                                <img src="<?= base_url() ?>/assets/user/img/home7/banner.png" />
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="brand-item">
                                <img src="<?= base_url() ?>/assets/user/img/brand/brand_img01.png" alt="">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="brand-item">
                                <img src="<?= base_url() ?>/assets/user/img/brand/brand_img02.png" alt="">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="brand-item">
                        ...
                        <div class="swiper-slide">
                            <div class="brand-item">
                                <img src="<?= base_url() ?>/assets/user/img/brand/brand_img04.png" alt="">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="brand-item">
                                <img src="<?= base_url() ?>/assets/user/img/brand/brand_img05.png" alt="">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="brand-item">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 mb-30">
                        <h3 class="text-capitalize mw-460">Engage with us for financial and accounting services with this step-by-step guide</h3>
                    </div>
                    <div class="col-lg-6 mb-30">
                        <p>Discover how our company can help your business with our comprehensive financial and accounting services. From bookkeeping to tax planning, we have you covered. Contact us today to get started.</p>
                    </div>
                </div>
                <div class="row mt-30">
                    <div class="col-lg-4 mb-40">
                        <div class="card-step">
                            ...
                            <div class="card-info">
                                ...
                                <p>Schedule a consultation with our experts to discuss your business needs and goals.</p>
                                <a href="#" class="link-readmore">
                                    Read More
        ...
        <section class="services-area services-bg">
            <div class="container">
                ...
                <div class="services-item-wrap">
                    <div class="row justify-content-center">
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-8">
                            <div class="services-item shine-animate-item">
                                <div class="services-thumb">
                                    <a href="services-details.html" class="shine-animate"><img src="<?= base_url() ?>/assets/user/img/services/services_img01.jpg" alt=""></a>
                                </div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-8">
                            <div class="services-item shine-animate-item">
                                <div class="services-thumb">
                                    <a href="services-details.html" class="shine-animate"><img src="<?= base_url() ?>/assets/user/img/services/services_img02.jpg" alt=""></a>
                                </div>
                                <div class="services-content">
                                    <div class="icon">
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-8">
                            <div class="services-item shine-animate-item">
                                <div class="services-thumb">
                                    <a href="services-details.html" class="shine-animate"><img src="<?= base_url() ?>/assets/user/img/services/services_img03.jpg" alt=""></a>
                                </div>
                                <div class="services-content">
                                    <div class="icon">
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-8">
                            <div class="services-item shine-animate-item">
                                <div class="services-thumb">
                                    <a href="services-details.html" class="shine-animate"><img src="<?= base_url() ?>/assets/user/img/services/services_img04.jpg" alt=""></a>
                                </div>
                                <div class="services-content">
                                    <div class="icon">
                                        <i class="flaticon-light-bulb"></i>
                ...
                <div class="services-bottom-content">
                    <a href="services.html" class="btn btn-two">See All Services</a>
                    <a href="contact.html" class="link-gray">Contact Us for a Quote</a>
                </div>
            </div>
        </section>
        <!-- services-area-end -->
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-xl-6 col-lg-8">
                            <div class="section-title text-center mb-40 tg-heading-subheading animation-style3">
                                <span class="sub-title">Features Projects</span>
                                <h2 class="title tg-element-title">Our Journey Towards<br class="d-none d-lg-block"> Financial Excellence</h2>
                                <p class="mb-25">With a track record of success, we have served numerous clients worldwide, providing top-notch financial and accounting services.</p>
                                <a href="about.html" class="btn" data-aos="fade-up" data-aos-delay="600">See All Services</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="testimonials_area-seven">
            <div class="container">
                ...
                <div class="slider_testimonial_home7">
                    <span class="quote-review"><img src="<?= base_url() ?>/assets/user/img/home7/quote.svg" /></span>
                    ...
                    <div class="row align-items-center justify-content-center">
                        <div class="col-lg-6 col-md-9 order-0 order-lg-2">
                            <div class="about__img-wrap-seven">
                                <img src="<?= base_url() ?>/assets/user/img/home7/img-about.png" alt="">
                                <div class="about__award-box about__award-box-two2">
                                    <img src="<?= base_url() ?>/assets/user/img/images/about_list_img04.png" alt="">
                                </div>
                                <div class="shape">
                                    <img src="<?= base_url() ?>/assets/user/img/images/h5_about_shape.png" alt="" class="ribbonRotate">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="about__content-seven">
                                ...
                                <a href="contact.html" class="btn btn-two">Contact With Us</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="choose-area">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 order-0 order-lg-2">
                        <div class="choose-img-wrap">
                            <img src="<?= base_url() ?>/assets/user/img/images/choose_img01.jpg" alt="">
                            <img src="<?= base_url() ?>/assets/user/img/images/choose_img02.jpg" alt="" data-parallax='{"x" : 50 }'>
                            <img src="<?= base_url() ?>/assets/user/img/images/choose_img_shape.png" alt="" class="alltuchtopdown">
                        </div>
                    </div>
                    <div class="col-lg-6">
            ...
            <div class="choose-shape-wrap">
                <img src="<?= base_url() ?>/assets/user/img/images/choose_shape01.png" alt="" data-aos="fade-right" data-aos-delay="400">
                <img src="<?= base_url() ?>/assets/user/img/images/choose_shape02.png" alt="" data-aos="fade-left" data-aos-delay="400">
            </div>
        </section>
        <!-- choose-area-end -->
        <!-- blog-post-area -->
            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-4 col-lg-6 col-md-10">
                        <div class="blog-post-item blog__post-three shine-animate-item">
                            <div class="blog-post-thumb blog__post-thumb-three">
                                <a href="blog-details.html" class="shine-animate"><img src="<?= base_url() ?>/assets/user/img/blog/blog_post01.jpg" alt=""></a>
                            </div>
                            <div class="blog-post-content blog__post-content-three">
                                ...
                                <a href="blog-details.html" class="btn">Continue Reading</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-6 col-md-10">
                        <div class="blog-post-item blog__post-three shine-animate-item">
                            <div class="blog-post-thumb blog__post-thumb-three">
                                <a href="blog-details.html" class="shine-animate"><img src="<?= base_url() ?>/assets/user/img/blog/blog_post02.jpg" alt=""></a>
                            </div>
                            <div class="blog-post-content blog__post-content-three">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-10">
                        <div class="blog-post-item blog__post-three shine-animate-item">
                            <div class="blog-post-thumb blog__post-thumb-three">
                                <a href="blog-details.html" class="shine-animate"><img src="<?= base_url() ?>/assets/user/img/blog/blog_post03.jpg" alt=""></a>
                            </div>
                            <div class="blog-post-content blog__post-content-three">
    ...
    <script src="<?= base_url() ?>/assets/user/js/jquery.odometer.min.js"></script>
    <script src="<?= base_url() ?>/assets/user/js/jquery.appear.js"></script>
    <script src="<?= base_url() ?>/assets/user/js/gsap.js"></script>
    <script src="<?= base_url() ?>/assets/user/js/ScrollTrigger.js"></script>
    <script src="<?= base_url() ?>/assets/user/js/SplitText.js"></script>
    <script src="<?= base_url() ?>/assets/user/js/gsap-animation.js"></script>
    <script src="<?= base_url() ?>/assets/user/js/jquery.parallaxScroll.min.js"></script>
    <script src="<?= base_url() ?>/assets/user/js/swiper-bundle.js"></script>
