                    ...
                    <div class="card">
                        <div class="card-body px-4 py-4-5">
                            <div class="row">
                                ...
                                <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                    <h6 class="text-muted font-semibold">User Belum Aktif</h6>
                                    <h6 class="font-extrabold mb-0" id="user_count_belum_aktif"></h6>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body px-4 py-4-5">
                            <div class="row">
                                ...
                                <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                    <h6 class="text-muted font-semibold">Saldo Connected</h6>
                                    <h6 class="font-extrabold mb-0" id="user_con_count"></h6>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body px-4 py-4-5">
                            <div class="row">
                                ...
                                <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                    <h6 class="text-muted font-semibold">Data Saldo</h6>
                                    <h6 class="font-extrabold mb-0" id="total_saldo"></h6>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="col-3">
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar avatar-md">
                                                        <img src="<?= base_url() ?>/assets/compiled/jpg/8.jpg">
                                                    </div>
                                        ...
                                        <tr>
                                            <td class="col-3">
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar avatar-md">
                                                        <img src="<?= base_url() ?>/assets/compiled/jpg/3.jpg">
                                                    </div>
