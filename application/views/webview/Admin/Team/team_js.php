...
<script>
    let jquery_datatable = $("#table1").DataTable({
        ...
        ajax: {
            url: "<?php echo site_url('Admin/team/ajax_list') ?> ",
            type: "POST",
            data: function(data) {}
        },
        columnDefs: [{
        ...
        if (!ttlnamaValue) {
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    var url;
                    var formData;
                    url = "<?php echo site_url('Admin/team/save') ?>";
        ...
        if (!ttlnamaValue) {
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    var url;
                    var formData;
                    url = "<?php echo site_url('Admin/team/process_insert_excel') ?>";
    ...
    function onEdit(id) {
        ...
        console.log('bisa 1')
        $.ajax({
            url: "<?php echo site_url('Admin/team/ajax_edit/') ?>" + id,
            type: "POST",
            dataType: "JSON",
            success: function(data) {
                ...
                $('#detail_posisi_edit').val(data.detail_posisi);
        ...
        if (!ttlnamaValue) {
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    var url;
                    var formData;
                    url = "<?php echo site_url('Admin/team/update') ?>";
    ...
    function onDelete(id) {
        ...
        swalWithBootstrapButtons.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: "<?php echo site_url('Admin/team/delete') ?>",
                    type: "POST",
                    data: {
                        id_delete: id
                    },
