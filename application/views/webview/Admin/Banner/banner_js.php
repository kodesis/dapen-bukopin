...
<script>
    let jquery_datatable = $("#table1").DataTable({
        ...
        ajax: {
            url: "<?php echo site_url('Admin/banner/ajax_list') ?> ",
            type: "POST",
            data: function(data) {}
        },
        columnDefs: [{
        ...
        if (!ttlnamaValue) {
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    var url;
                    var formData;
                    url = "<?php echo site_url('Admin/banner/save') ?>";
        ...
        if (!ttlnamaValue) {
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    var url;
                    var formData;
                    url = "<?php echo site_url('Admin/banner/process_insert_excel') ?>";
    ...
    function onEdit(id) {
        ...
        console.log('bisa 1')
        $.ajax({
            url: "<?php echo site_url('Admin/banner/ajax_edit/') ?>" + id,
            type: "POST",
            dataType: "JSON",
            success: function(data) {
        ...
        if (!ttlnamaValue) {
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    var url;
                    var formData;
                    url = "<?php echo site_url('Admin/banner/update') ?>";
